...
style_params = {
    ...
    "sacred_flame": {
        ...
        "hue_range": (
            ...
            0.47,
            0.52,
        ),  # 主要集中在黄色及其附近的色调，适量加入绿色和少量蓝色
        "saturation_range": (0.8, 1.0),  # 高饱和度，表现出色彩的强烈和鲜明
        "value_range": (0.8, 1.0),  # 高亮度，体现出火焰般的光辉
    },
    "dreaming_glade": {
        # 梦之林间空地 - 专为《林中花》定制的风格
        # 色相范围：以绿蓝紫为主，辅以少量暖橙，模拟林间水气与夕光
        "hue_range": (0.25, 0.75, 0.08, 0.12),
        # 饱和度：低到中等，体现柔和与内敛
        "saturation_range": (0.2, 0.45),
        # 明度：中等偏低，保持宁静的光影感
        "value_range": (0.3, 0.6),
    }
}
