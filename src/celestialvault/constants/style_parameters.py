...
style_params = {
    ...
    "sacred_flame": [
        ...
        {
            "hue_range": (0.16, 0.18),  # 黄色
            "saturation_range": (0.8, 1.0),
            "value_range": (0.8, 1.0),
            "weight": 2,  # 次亮光
        },
        {
            "hue_range": (0.47, 0.52),  # 绿色/蓝色光晕
            "saturation_range": (0.8, 1.0),
            "value_range": (0.8, 1.0),
            "weight": 1,  # 辅色光晕
        }
